...
@Component({
  selector: 'app-ressource-humaine-item',
  standalone: true,
  imports: [
    BrnSelectImports,
    HlmSelectImports,
  ...
  templateUrl: './ressource-humaine-item.component.html',
  styleUrl: './ressource-humaine-item.component.css'
})
export class RessourceHumaineItemComponent implements OnInit{
  @Input() ressource!: any;
